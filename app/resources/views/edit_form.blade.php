  ...
  <div class="formContainer">  
    ...
    <form id="contact" action="{{ url('/newUser') }}" method="post">
     ...
     @endif
      ...
      <fieldset>
        <input placeholder="Phone Number " name="phone" type="tel" tabindex="3" value="{{ old('phone') }}" required>
      </fieldset>
      
      <fieldset>
        <input placeholder="Address" name="address" type="tel" tabindex="4" value="{{old('address')}}" required>
      </fieldset>
      ...
      <fieldset>
        ...
        <input type='text' placeholder="birthday  day-month" value="{{ old('birthday') }}" id="datepicker" name="birth" style="width:30%;" />
      </fieldset>
      <fieldset>
